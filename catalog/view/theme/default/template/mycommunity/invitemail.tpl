...
<title>JANE JOSPHINE</title>
</head>
<body>
    <div style="border-radius:5px;border:solid 1px #dfdfdf;font-family:Arial;word-wrap:break-word;width:670px;">
    <table style="background-color:#ededed;border-radius:5px 5px 0 0;width:670px"cellspacing="0"cellpaddin"0">
    <tbody>
    <tr>
    <td>
    <div style="padding:30px 30px 0;font-size:20px">
    <?php echo $text_olai; ?>
    <div style="margin-top:20px;width:0;height:0;border-bottom:10px solid #fff;border-left:10px solid transparent;border-right:10px solid transparent"></div>
    </div>
    </td>
    <td style="vertical-align:middle;text-align:right;padding-right:30px"><img src="" class=""></td>
    </tr>
    </tbody>
    </table>

    <div style="font-size:14px;line-height:18px;background-color:#fff">
    ...
    <td style="width:578px;color:#333;font:13px Arial;vertical-align:top">
    <!--<img style="border:solid 1px #cccccc" src="" width="75"height="75"class="">-->
    ...
    <div style="border-top:solid 1px #dfdfdf;background-color:#fff;padding:30px;font-size:14px;line-height:18px;border-radius:0 0 5px 5px">
    ...
    <td>
    <table style="padding-left:5px" cellpadding="5">
    <tbody>
    <tr style="vertical-align:top">
    <td>
    <?php echo $text_cviac; ?>
    ...
    <td style="background-color:#d44b38;border:solid 1px #dfdfdf;border-radius:3px;color:#fff;display:inline-block;font-family:Arial;font-size:13px;height:30px;line-height:30px;min-width:54px;padding:1px 20px;text-align:center;text-decoration:none;white-space:nowrap">
    Preview Club 
    </td>
    </tr>
    </tbody>
