...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['cover_type'])) {
			$data['cover_type'] = $this->request->post['cover_type'];
		} elseif (!empty($product_info)) {
		...
		if (isset($this->request->post['no_of_pages'])) {
			$data['no_of_pages'] = $this->request->post['no_of_pages'];
		} elseif (!empty($product_info)) {
