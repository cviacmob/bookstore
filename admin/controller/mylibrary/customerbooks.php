<?php
class ControllerMylibraryCustomerbooks extends Controller {
	private $error = array();

	public function index() {
		 $this->load->language('mylibrary/customerbooks');

		 $this->document->setTitle($this->language->get('heading_title'));

		 $this->load->model('mylibrary/customerbooks');
	...
	public function edit() {
	    ...
	    $club_info = $this->model_mylibrary_customergroups->getClubs($group_id);
		...
		$data['cancel'] = $this->url->link('mylibrary/customerbooks', 'token=' . $this->session->data['token'] . $url, true);
		...
		$data['update_details'] = $this->url->link('mylibrary/customerbooks/updateDetails','token=' .$this->session->data['token'].'&group_id=','',true);

		$this->response->setOutput($this->load->view('mylibrary/customerbooks_list_edit', $data));
	}
	...
	public function updateDetails()
	{
		...
		$this->model_mylibrary_customerbooks->updateDetails($this->request->get['group_id']);
    ...
    protected function getList() {
		...
		$clubs = $this->model_mylibrary_customerbooks->getTotalClub();
		...
		foreach ($clubs->rows as $club) {
			...
			$customer_name = $this->model_mylibrary_customerbooks->getCus_name($club['created_by']);
			...
			$data['clubs'][] = array(
            	...
            	'edit'       	   => $this->url->link('mylibrary/customerbooks/edit','token=' . $this->session->data['token'] .'&group_id='.$club['group_id'],'',true)
			);
		}
		...
		$this->response->setOutput($this->load->view('mylibrary/customerbooks_list', $data));
	}
