...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <h1>Edit Customer created Groups</h1>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i> Add groups to Reading Club</h3>
      </div>
      ...
      <img src="<?php echo $club_info['group_image']; ?>">
      <br>
      ...
      <form action="<?php echo $update_details.$club_info['group_id']; ?>" method="post">
       ...
       Group Name <input class="form-control input-lg" type="text" name="group_name" value="<?php echo $group_name; ?>"><br>
       Group Description <br> <input class="form-control input-lg" type="textarea" name="group_description" value="<?php echo $group_description; ?>"><br>
       Location <br><input class="form-control input-lg" type="text" name="location" value="<?php echo $location; ?>"><br>
       Privacy <br> <input class="form-control input-lg" type="text" name="privacy" value="<?php echo $privacy; ?>"><br>
       <div class="form-group required" >
                <label class="control-label" for="input-status">Recommended</label>
              
                  <select name="recommended" id="input-status" class="form-control">
				   <?php if ($club_info['recommended']=='true') { ?>
			  ...
			  <div class="form-group required" >
                <label class="control-label" for="input-status">Status</label>
                  ...
                  <select name="status" id="input-status"   class="form-control">
                   <?php if ($club_info['status']=='active') { ?>
