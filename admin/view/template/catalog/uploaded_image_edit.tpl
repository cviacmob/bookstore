  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i> Add Book to Master</h3>
      </div>
      ...
      <img src="<?php echo $upload_info['front_image']; ?>">
      <br>
      <img src="<?php echo $upload_info['back_image']; ?>">
      <br>
      <div class="">
      ...
      <form action="<?php echo $update_details.$club_info['group_id']; ?>" method="post">
       ...
       ISBN <input class="form-control input-lg" type="text" name="isbn" value="<?php echo $isbn; ?>"><br>
       Title <br> <input class="form-control input-lg" type="text" name="title" value="<?php echo $title; ?>"><br>
       Author <br><input class="form-control input-lg" type="text" name="author" value="<?php echo $author; ?>"><br>
       Publisher <br> <input class="form-control input-lg" type="text" name="publisher" value="<?php echo $publisher; ?>"><br>
       No of Pages <br><input class="form-control input-lg" type="text" name="no_of_pages" value="<?php echo $no_of_pages; ?>"><br>
       Cover type <br> <input class="form-control input-lg" type="text" name="cover_type" value="<?php echo $cover_type; ?>"><br>
       Description <br><input class="form-control input-lg" type="text" name="description" value="<?php echo $description; ?>"><br>
       Sell Price <br><input class="form-control input-lg" type="text" name="sell_price" value=""><br>
       Share Price <br><input class="form-control input-lg" type="text" name="share_price" value=""><br>
